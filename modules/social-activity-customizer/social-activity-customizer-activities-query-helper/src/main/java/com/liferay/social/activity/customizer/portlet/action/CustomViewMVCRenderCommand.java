...
import com.liferay.social.activity.customizer.activities.query.helper.CustomSocialActivitiesQueryHelper;
...
public class CustomViewMVCRenderCommand implements MVCRenderCommand {
	...
	private CustomSocialActivitiesQueryHelper _customSocialActivitiesQueryHelper;

	@Reference(target = "(component.name=com.liferay.social.activities.web.internal.portlet.action.ViewMVCRenderCommand)")
