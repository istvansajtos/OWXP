...
public class WikiPageCustomServiceSoap {
	public static com.liferay.wiki.model.WikiPage movePageToTrash(long nodeId,
		...
		try {
			com.liferay.wiki.model.WikiPage returnValue = WikiPageCustomServiceUtil.movePageToTrash(nodeId,
					title);
	...
	private static Log _log = LogFactoryUtil.getLog(WikiPageCustomServiceSoap.class);
}