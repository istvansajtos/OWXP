...
/**
 * Provides the local service interface for CustomBookmarksEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CustomBookmarksEntryLocalServiceUtil
...
public interface CustomBookmarksEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomBookmarksEntryLocalServiceUtil} to access the custom bookmarks entry local service. Add custom service methods to {@link com.liferay.bookmarks.customizer.service.impl.CustomBookmarksEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
