...
public class FooServiceHttp {
	public static void print(HttpPrincipal httpPrincipal) {
		try {
			MethodKey methodKey = new MethodKey(FooServiceUtil.class, "print",
					_printParameterTypes0);
	...
	public static com.liferay.wiki.model.WikiPage movePageToTrash(
		...
		try {
			MethodKey methodKey = new MethodKey(FooServiceUtil.class,
					"movePageToTrash", _movePageToTrashParameterTypes2);
	...
	private static final Class<?>[] _printParameterTypes0 = new Class[] {  };
	private static final Class<?>[] _movePageToTrashParameterTypes1 = new Class[] {
			long.class, java.lang.String.class
		};
	private static final Class<?>[] _movePageToTrashParameterTypes2 = new Class[] {
